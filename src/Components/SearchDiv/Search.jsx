    ...
    <div className='searchDiv grid gap-10 bg-greyIsh rounded-[10px] p-[3rem]'>
      ...
      <form action=''>
        ...
        [10px] bg-white p-5 shadow-lg shadow-greyIsh-700'>
          ...
          <div className='flex gap-2 items-canter'>
            <AiOutlineSearch className='text-[25px] icon'/>
            <input type='text' className='bg-transparent text-black-500
      ...
      <div className='secDiv flex items-center gap-10 justify-center'>
        ...
        <div className='singleSearch flex items-center gap-2'>
          ...
          <select name='' id='relevance'_className='bg-white rounded-[3px] ps-4 py-1'>
