...
{/* First card (Values) */}
        <div className='singleGrid rounded-[10px] hover:bg-[#dedef8] p-[1.5rem]'>
...
{/* Second card (Values) */}
        <div className='singleGrid rounded-[10px] hover:bg-[#f7edf5] p-[1.5rem]'>
          ...
          <div className='flex items-center gap-3'>
            <div className='imgDiv p-[4px] rounded-[.8rem] bg-[#f7edf5] h-
            [40px] w-[40px] flex items-center justify-center'>
        ...
        <div className='singleGrid rounded-[10px] hover:bg-[#fcfae3] p-[1.5rem]'>
          ...
          <div className='flex items-center gap-3'>
            <div className='imgDiv p-[4px] rounded-[.8rem] bg-[#f3f2ad] h-
            [40px] w-[40px] flex items-center justify-center'>
